...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reciteWordsInLabel__ = __webpack_require__(274);
...
ReciteWordsModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [__WEBPACK_IMPORTED_MODULE_1__reciteWordsInLabel__["a" /* ReciteWordsInLabelPage */]],
        imports: [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_1__reciteWordsInLabel__["a" /* ReciteWordsInLabelPage */])],
        entryComponents: [__WEBPACK_IMPORTED_MODULE_1__reciteWordsInLabel__["a" /* ReciteWordsInLabelPage */]]
    })
], ReciteWordsModule);

//# sourceMappingURL=reciteWordsInLabel.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ReciteWordsInLabelPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(97);
...
var ReciteWordsInLabelPage = (function () {
    function ReciteWordsInLabelPage(navCtrl, rest, actionSheetCtrl, modalCtrl, toastCtrl, labelParams) {
    ...
    ReciteWordsInLabelPage.prototype.ionViewDidLoad = function () {
        //console.log('ionViewDidLoad')
    };
    ReciteWordsInLabelPage.prototype.ionViewDidEnter = function () {
        //this.getRecitWordsList(this.params,function(){})
    };
    ReciteWordsInLabelPage.prototype.playVoice = function (event, voiceData, mp3) {
    ...
    ReciteWordsInLabelPage.prototype.getRecitWordsLabelList = function (params, callback) {
        var that = this;
    ...
    ReciteWordsInLabelPage.prototype.doRefresh = function (refresher) {
        var that = this;
    ...
    ReciteWordsInLabelPage.prototype.pushElementNotRepeat = function (array, item, key) {
        var result = true;
    ...
    ReciteWordsInLabelPage.prototype.doInfinite = function (infiniteScroll) {
        var that = this;
    ...
    ReciteWordsInLabelPage.prototype.multiButton = function (event, item) {
        var that = this;
        console.log(item);
    ...
    ReciteWordsInLabelPage.prototype.labelPage = function (event) {
        /*let modal = this.modalCtrl.create(LabelPage);
        modal.present();*/
        this.navCtrl.push('LabelPage');
    };
    ReciteWordsInLabelPage.prototype.labelPageSetting = function (event) {
        var that = this;
    ...
    ReciteWordsInLabelPage.prototype.checkTheTranslate = function ($event, item) {
        var that = this;
        var toast = that.toastCtrl.create({
            message: item['means'],
            duration: 3000,
...
], ReciteWordsInLabelPage);

//# sourceMappingURL=reciteWordsInLabel.js.map
